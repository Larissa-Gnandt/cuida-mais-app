                    ...
                    SliverList.list(
                      children: const [
                        ...
                        _InstructionStepCard(
                          ...
                          instruction:
                              'Pressione o local do sangramento com pano limpo ou gaze por alguns minutos.',
                        ),
                        SizedBox(height: 14),
                        _InstructionStepCard(
                          number: '02',
                          ...
                          instruction:
                              'Mantenha a pressão contínua e eleve o membro ferido, se isso for possível.',
                        ),
                        SizedBox(height: 14),
                        _InstructionStepCard(
                          number: '03',
                          ...
                          instruction:
                              'Se o curativo encharcar, coloque outro por cima sem remover o primeiro.',
                        ),
                        SizedBox(height: 26),
                        _ImportantAlertCard(),
                        SizedBox(height: 20),
...
class _BleedingHeader extends StatelessWidget {
  const _BleedingHeader();
    ...
    return Row(
      ...
      children: [
        const Icon(
          ...
          color: BleedingEmergencyScreen._primaryGreen,
          size: 24,
        ),
        ...
        Expanded(
          child: Text(
            ...
            style: theme.textTheme.titleLarge?.copyWith(
              color: BleedingEmergencyScreen._ink,
              fontSize: 18,
              height: 1.18,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(
                ...
                color: BleedingEmergencyScreen._dangerRed,
                size: 16,
              ),
          ...
          Text(
            'Se o sangramento for intenso ou não parar, chame o socorro médico imediatamente.',
            style: theme.textTheme.bodyMedium?.copyWith(
              color: BleedingEmergencyScreen._dangerRed,
              fontSize: 12,
              height: 1.35,
...
class _StepIconBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Icon(icon, color: BleedingEmergencyScreen._primaryGreen, size: 24),
    );
  }
}
