...
class BurnEmergencyScreen extends StatelessWidget {
  const BurnEmergencyScreen({super.key, required this.onDismiss});
                    ...
                    SliverList.list(
                      children: const [
                        ...
                        _InstructionStepCard(
                          ...
                          instruction:
                              'Resfrie a área queimada em água corrente fria por pelo menos 10 minutos.',
                        ),
                        SizedBox(height: 14),
                        _InstructionStepCard(
                          number: '02',
                          ...
                          instruction:
                              'Retire anéis, relógios ou roupas apertadas, se não estiverem grudados na pele.',
                        ),
                        SizedBox(height: 14),
                        _InstructionStepCard(
                          number: '03',
                          ...
                          instruction:
                              'Cubra a queimadura com pano limpo ou gaze, sem apertar a região.',
                        ),
                        SizedBox(height: 26),
                        _ImportantAlertCard(),
                        SizedBox(height: 20),
...
class _BurnHeader extends StatelessWidget {
  const _BurnHeader();
    ...
    return Row(
      ...
      children: [
        const Icon(
          ...
          color: BurnEmergencyScreen._primaryGreen,
          size: 24,
        ),
        ...
        Expanded(
          child: Text(
            ...
            style: theme.textTheme.titleLarge?.copyWith(
              color: BurnEmergencyScreen._ink,
              fontSize: 18,
              height: 1.18,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(
                ...
                color: BurnEmergencyScreen._dangerRed,
                size: 16,
              ),
          ...
          Text(
            'Não use gelo, pasta, óleo ou manteiga. Se for grave, chame o socorro médico imediatamente.',
            style: theme.textTheme.bodyMedium?.copyWith(
              color: BurnEmergencyScreen._dangerRed,
              fontSize: 12,
              height: 1.35,
...
class _StepIconBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Icon(icon, color: BurnEmergencyScreen._primaryGreen, size: 24),
    );
  }
}
